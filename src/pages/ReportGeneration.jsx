...
export const ReportEditor = forwardRef(({ report, reports, onBack, hideBackButton, ActionButtons, autoPrint, onAfterPrint, onMount }, ref) => {
    ...
    return (
        <Box>
            ...
            <Box className="print-container" ref={ref}>
                    ...
                    return (
                        <div key={rIndex} className="report-section" style={rIndex > 0 ? { breakBefore: 'page' } : {}}>
                            ...
                            {photoChunks.map((chunk, pageIndex) => (
                                <div className="a4-page" key={`photo-${pageIndex}`}>
                                    {/* Photo Page Header */}
                                    <table style={{ width: '100%', borderCollapse: 'collapse', border: '2px solid black', marginBottom: 0 }}>
                                        <tbody>
                                            <tr>
                                                                    ...
                                                                    {row.photoUrls && row.photoUrls.map((url, imgIndex) => {
                                                                        ...
                                                                        return (
                                                                            <div key={imgIndex} style={{ width: width, position: 'relative' }}>
                                                                                <img
                                                                                    src={url}
                                                                                    alt={`Photo ${globalIndex + 1}.${imgIndex + 1}`}
                                                                                    crossOrigin="anonymous"
                                                                                    style={{ width: '100%', objectFit: 'contain', border: '1px solid #ccc' }}
                                                                                />
                                                                                <div style={{
